        ...
        <script type="text/javascript">
            $(document).ready( function () {
                    ...
                    columns: [
                        {
                            ...
                            render: function (data, type, row, meta) {
                                ...
                                return '<a class="btn btn-info btn-sm" href="${base}/terminal/'+ data +'" role="button">' +
                ...
                function inlineEditCallback (updatedCell, updatedRow, oldValue) {
                    $.ajax({
                        type: "put",
                        url: "${base}/api/terminals/" + updatedRow.data().id,
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Are you really sure you want to delete terminal with name <code id="delete-name"></code>.</p>
                    </div>

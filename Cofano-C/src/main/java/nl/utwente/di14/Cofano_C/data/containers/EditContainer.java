...
@WebServlet(description="Application Data Servlet", urlPatterns={"/containers/*"})

public class EditContainer extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		request.setAttribute("formUrl", getServletContext().getInitParameter("cofano.url") + "/api/containers/" + appId);

...
@WebServlet(description="Application Data Servlet", urlPatterns={"/terminal/*"})

public class EditTerminal extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		request.setAttribute("formUrl", getServletContext().getInitParameter("cofano.url") + "/api/terminals/" + appId);
